...
export default function ProductMobileBar({ product }: { product: Smoothie }) {
  ...
  return (
    <div
      className={cn(
        'sm:hidden fixed bottom-20 left-0 right-0 h-20 bg-white/80 backdrop-blur-lg border-t border-gray-200/80 flex items-center justify-between p-4 gap-4 z-40',
