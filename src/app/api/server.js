// Next.js loads .env automatically, no need for dotenv
...
// Middleware - Simplified CORS for Next.js integration
// In Next.js API routes, requests are same-origin, so CORS is permissive
app.use(cors({
  origin: true, // Allow all origins (Next.js handles this)
  credentials: true,
...
// Morgan disabled in Next.js serverless environment
// app.use(morgan('dev'));
...
// Export app for Next.js API routes (no standalone server needed)
// Next.js will handle the server startup
